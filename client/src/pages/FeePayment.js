  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          try {
            ...
            const verifyResponse = await apiClient.post("/api/verify-payment", {
            ...
            if (verifyResponse.data.success) {
              ...
              const paymentDate =
                verifyResponse.data.paymentDate || new Date().toISOString();
              ...
              try {
                ...
                console.warn(
                  "⚠️ UserContext sync failed (non-critical):",
                  mongoError,
                );
              }
      ...
      razorpayInstance.on("payment.failed", function (response) {
        ...
        toast.error(
          `Payment failed: ${response.error.description || "Unknown error"}. You can retry.`,
        );
        setLoading(false);
      });
      ...
      if (
        ...
        console.error(
          "🌐 Network error - Server may be offline at:",
          API_BASE_URL,
        );
      }
