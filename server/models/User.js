...
// ============================================
// PRE-SAVE HOOK — Normalize phone & email
// ============================================
UserSchema.pre("save", function () {
  ...
  // Normalize phone: strip +91, 0 prefix, spaces, dashes
...
UserSchema.methods.addPayment = function (paymentData) {
  ...
  const historyEntry = {
    transactionId:
      paymentData.paymentId || paymentData.orderId || paymentData.transactionId,
